                ...
                <div className="flex items-center space-x-3">
                  ...
                  {!isInstalled && (
                    <button
                      ...
                      className="hidden md:flex items-center space-x-2 px-3 py-1.5 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white rounded-lg text-sm font-medium transition-all transform hover:scale-105"
                      title="Install App"
                    >
            ...
            <div className="text-center mb-8">
              ...
              {!isInstalled && (
                <div className="mt-4 md:hidden">
                  <button
                    onClick={() => setShowInstallGuide(true)}
                    className="inline-flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white rounded-lg text-sm font-medium transition-all transform hover:scale-105 animate-bounce-gentle"
                  >
                    <Download className="w-4 h-4" />
